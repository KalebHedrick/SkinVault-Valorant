...
const HomeScreen = () => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <TouchableOpacity><Text style={styles.baseText}>First time Opening app? Click Here.</Text></TouchableOpacity>
      <View style={styles.skinVault}>
        <Text style={styles.mainWheelHeadText}>Total Skins in Vault</Text>
        <SkinProgressCircle />
      </View>
    </SafeAreaView>
  );
  ...
  if (loading) {
    ...
    return (
      <AnimatedCircularProgress
        size={(windowHeight + windowWidth) / 5}
        width={(windowHeight + windowWidth) / 30}
        duration={2000}
      ...
      >
        {
          (fill) => (
            <Text style={styles.mainWheelHeadText}>
...
const styles = StyleSheet.create({
  ...
  mainWheelHeadText: {
    fontFamily: "RobotMain",
    fontSize: (windowHeight + windowWidth) / 55,
    color: appColors.WHITE,
    textAlign: "center",
  },
  skinVault: {
    ...
    justifyContent: "center",
    alignItems: "center",
    padding: (windowHeight + windowWidth) / 20,
  },
});
